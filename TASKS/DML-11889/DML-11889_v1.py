...
PayOverviewButton = driver.find_element(By.ID, 'PaymentsOverview')
PayOverviewButton.click()
time.sleep(5)

def IsDashboardDisplayed():
    DashboardTitle = driver.find_elements(By.ID, 'lk-react-container')
    print("Payments Overview Global Dashboard has been displayed properly")

    for x in DashboardTitle:
        print(x.text())
